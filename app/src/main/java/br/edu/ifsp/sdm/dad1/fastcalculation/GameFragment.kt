...
import br.edu.ifsp.sdm.dad1.fastcalculation.databinding.FragmentGameBinding
...
class GameFragment : Fragment() {
    ...
    private fun play() {
        ...
        if(currentRound != null) {
            ...
            val result = "%.1f".format(points)
            parentFragmentManager.beginTransaction().replace(R.id.gameFl, ResultFragment.newInstance(result)).commit()
        }
    }
}